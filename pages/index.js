...
import { executives } from "../helpers/data/executiveData";
    ...
    <>
      ...
      <Layout className="layout">
        ...
        <Content>
          ...
          <div className="keyExecutiveSection">
            <div class="text-white text-[60px] font-semibold tracking-widest text-center mb-3">
              Our Key Executives
            </div>
            <div className="keyExecutive">
              {executives.map((item, index) => (
                <div className="card" key={index}>
                  <img
                    ...
                    height="512"
                  ></img>
                  <div class="text-white font-mono text-3xl font-semibold tracking-widest text-center mt-4">
                    {item.name}
                  </div>
                  <div class="text-cyan-300 text-xl font-semibold tracking-widest text-center mt-2">
                    {item.position}
                  </div>
                  <div class="text-white text-xl tracking-widest text-center mt-8">
                    {item.speech}
                  </div>
                </div>
              ))}
                  ...
                  <ul class="text-gray-600">
                    <li class="mb-4">
                      <a href="#" class="hover:underline">
                        Align Electromechanical Work LLC
                      </a>
                    </li>
                    <li>
                      <a
